...
export default function Projects() {
  return (
    <div className="flex flex-col justify-center items-center bg-[#E6DACE]">
      ...
      <div className="lg:w-[50%] mx-4 bg-white shadow-2xl rounded-lg flex justify-between my-8 flex-col lg:flex-row">
        <div className="px-10 py-10  lg:w-[60%] flex flex-col">
          <div>
            <h1 className="text-[#0050FF] text-xl font-bold">Weather Master</h1>
            <p className="text-md font-semibold ">Role Title</p>
            <p className="text-sm font-extralight">
              React, Node.js, and Tailwind CSS
            </p>
          </div>
          <p className="mt-4 lg:my-10 font-light">
      ...
      <div className="lg:w-1/2 mx-4 bg-white shadow-2xl rounded-lg flex justify-between my-8 flex-col lg:flex-row">
        <div className="px-10 py-10 lg:w-[60%] flex flex-col">
          <div>
